...
file_name = "happo_learning_data_test_"
...
for i in range(1):
    ...
    actor_weight = actor_weight_base + "_" + file_name + str(i)
    critic_weight = critic_weight_base + "_" + file_name + str(i)
    happo_trainer.train_loop_single(max_epi_itr, buffer_size, batch_size, eps_clip, backup_iter, device, result_dir, actor_weight, critic_weight, learning_data_index_path, output)
    #V_net_weight = V_net_weight_base + "_" + file_name + str(i)
