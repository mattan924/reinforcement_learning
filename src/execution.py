...
if __name__ == '__main__':
    ...
    #  読み込む重みパラメータ
    load_parameter = "../result/0228/model_parameter/"

    #  結果出力先ファイル
    output_file = "../dataset/execution_data/solution/test5000.csv"

    #  結果確認用アニメーション
    output_animation = "../dataset/execution_data/animation/test5000.gif"
